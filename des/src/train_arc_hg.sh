...
python main.py arc --dataset arc --exp_id arc_hg_bs24 --arch hourglass --batch_size 24 --master_batch 4 --lr 2.5e-4 --load_model ../models/ExtremeNet_500000.pth --gpus 0,1,2,3
